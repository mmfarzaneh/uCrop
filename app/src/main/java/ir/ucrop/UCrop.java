...
public class UCrop {
    ...
    /**
     * Get Intent to start {@link ir.ucrop.UCropActivity}
     *
     * @return Intent for {@link ir.ucrop.UCropActivity}
     */
    public Intent getIntent(@NonNull Context context) {
        mCropIntent.setClass(context, ir.ucrop.UCropActivity.class);
        mCropIntent.putExtras(mCropOptionsBundle);
        return mCropIntent;
    }
    ...
    public static class Options {
         ...
         */
        public void setAllowedGestures(@ir.ucrop.UCropActivity.GestureTypes int tabScale,
                                       @ir.ucrop.UCropActivity.GestureTypes int tabRotate,
                                       @ir.ucrop.UCropActivity.GestureTypes int tabAspectRatio) {
