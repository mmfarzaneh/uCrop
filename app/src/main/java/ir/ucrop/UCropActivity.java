...
import ir.ucrop.callback.BitmapCropCallback;
import ir.ucrop.immersion.CropImmersiveManage;
import ir.ucrop.model.AspectRatio;
import ir.ucrop.util.FileUtils;
import ir.ucrop.util.MimeType;
import ir.ucrop.util.ScreenUtils;
import ir.ucrop.util.SelectedStateListDrawable;
import ir.ucrop.view.CropImageView;
import ir.ucrop.view.GestureCropImageView;
import ir.ucrop.view.OverlayView;
import ir.ucrop.view.TransformImageView;
import ir.ucrop.view.UCropView;
import ir.ucrop.view.widget.AspectRatioTextView;
import ir.ucrop.view.widget.HorizontalProgressWheelView;
...
public class UCropActivity extends AppCompatActivity {
    ...
    /**
     * This method extracts {@link ir.ucrop.UCrop.Options #optionsBundle} from incoming intent
